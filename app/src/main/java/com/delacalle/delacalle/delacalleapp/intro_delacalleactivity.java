...
try {
    ...
    addSlide(AppIntroFragment.newInstance("¿Cómo es la membresía?", "La membresía es una tarjeta con el logo del club De La Calle ", R.drawable.tuto6, Color.rgb(26, 26, 26)));
    addSlide(AppIntroFragment.newInstance("¿Cómo buscas ofertas?", "Puedes buscar las ofertas usando nuestra app o visitando la web delacalle.co ", R.drawable.tuto7, Color.rgb(26, 26, 26)));
